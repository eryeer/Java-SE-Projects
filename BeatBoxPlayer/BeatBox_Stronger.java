...
public class BeatBox_Stronger {
	...
	JFrame theFrame;
	//ÀÖÆ÷Ãû³Æ
	String[] instrumentNames = { "Instrument","Bass Drum", "Closed Hi-Hat", "Open Hi-Hat",
	...
	public void buildGUI() {
		...
		//ÉèÖÃÃæ°åÉÏ°ÚÉè×é¼þµÄ¿Õ°×±ß¿ò¾àÀë
		...
		GridLayout grid = new GridLayout(17, 32);
		grid.setVgap(1);
		grid.setHgap(2);
		...
		for (int i = 0; i < 32; i++) {
			if (i < 9) {
				JLabel comp = new JLabel("0" + (i+1) + "");
				comp.setHorizontalAlignment(JLabel.CENTER);
				mainPanel.add(comp);
			}else {
				JLabel comp = new JLabel(i+1+"");
				comp.setHorizontalAlignment(JLabel.CENTER);
				mainPanel.add(comp);
			}
